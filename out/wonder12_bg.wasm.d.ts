...
export function game12(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function wasm_bindgen__convert__closures__invoke0_mut__h71e5d724c5a330d9(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h1442e8f1edee7323(a: number, b: number, c: number): void;
